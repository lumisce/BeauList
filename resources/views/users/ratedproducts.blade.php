					...
					@foreach (Auth::user()->ratedProducts->reverse() as $product)
						<div class="product-list-item list-group-item">
							...
							<div class="product-other">
								<p class="other-info"><span class="my-rating"><i class="rating-icon rating-icon-star fa fa-star"></i> <span>{{Auth::user()->ratedProducts->find($product->id)->rating->score}}</span></span></p>
								@guest
