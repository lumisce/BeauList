						...
						@foreach ($item->products as $product)
							<div class="product-list-item list-group-item">
								<a href="/brands/{{$product->brand->id}}">
									<img src="{{$product->brand->image}}" style="height:100px;width:100px;display:inline-block; margin-right:10px;">
								</a>
								<a href="/products/{{$product->id}}">
									<img src="{{$product->image}}" style="height:100px;width:100px;display:inline-block; margin-right:10px;">
...
$('.add-to-list .dropdown-item').on('click', function() {
	...
	var $this = $(this);
	console.log($('#list-id-input').val() == {{request()->route('list')}});
